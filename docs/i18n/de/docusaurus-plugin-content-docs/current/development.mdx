...
Docker kann mit [dieser Anleitung](https://docs.docker.com/desktop/setup/install/mac-install/) installiert werden.
...
[Kugelblitz-Project-intellij-code-style.xml](http://github.com/paion-data/.github/blob/master/intellij/Paion-Data-WS-Project-intellij-code-style.xml)
...
[ArangoDB-Dokumentation](https://arango.paion-data.dev/stable/components/web-interface/)
