...
it also supports
[running template webserivce in Docker](https://github.com/paion-data/Kugelblitz/blob/master/src/test/java/com/paion-data/kugelblitz/DockerComposeIT.java).
...
[Paion-Data-WS-Project-intellij-code-style.xml](https://raw.githubusercontent.com/paion-data/.github/refs/heads/master/Paion-Data-WS-Project-intellij-code-style.xml)
